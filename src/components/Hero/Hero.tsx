    ...
    <div>
      <section className="container flex flex-col items-center px-6 py-12 mx-auto lg:flex-row">
        <div className="lg:w-1/2">
          <h1 className="max-w-xl font-serif text-4xl font-medium tracking-wide text-black capitalize md:text-6xl">
            A beautiful adventure awaits
          </h1>

          <p className="max-w-lg mt-4 text-gray-500">
            "Unlocking Potential, Nurturing Character – Our school empowers
            children through education and enriches their lives with essential
            soft skill development, fostering confident, compassionate, and
            capable individuals."
          </p>
        ...
        <div className="h-[24rem] lg:h-[38rem] mt-12 lg:mt-0 w-full mx-auto max-w-md overflow-hidden rounded-t-full outline outline-4 outline-offset-4 outline-blue-400/40">
          <img
