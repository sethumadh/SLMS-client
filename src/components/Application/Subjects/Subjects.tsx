...
function Subjects() {
  ...
  const termSubjects = currentTerm.data
  console.log(termSubjects?.termSubjectGroup)
          ...
          <div className="px-4 py-6 sm:p-8">
            <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  {currentTerm.data?.termSubjectGroup?.map(
                    (termSubject, index) => (
                      <div key={index}>
                        {termSubject.termSubject.map((subject, i) => (
                          <div key={i}>
                            <div className="relative flex gap-x-3">
                              <div className="flex h-6 items-center">
                                ...
                                id={subject.subject.name}
                                  ...
                                  {...register(
                                    "subjectInterest.subjectsChosen",
                                    {
                                      required: {
                                        value: true,
