...
import { teacherPersonalDetailsSchema } from "@/api/admin/teacherApprove"

export type TeacherPersonalDetailsSchema = z.infer<
  typeof teacherPersonalDetailsSchema
>
...
function NewTeacherApplicantPersonalDetails() {
  ...
  const {
    ...
    state,
    suburb,
  } = applicantData?.teacherPersonalDetails ?? {}
  const methods = useForm<TeacherPersonalDetailsSchema>({
    resolver: zodResolver(teacherPersonalDetailsSchema),
  ...
  const onSubmit = (values: TeacherPersonalDetailsSchema) => {
    console.log(values)
    setIsEdit(false)
  }
  useEffect(() => {
...
export default NewTeacherApplicantPersonalDetails
