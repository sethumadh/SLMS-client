...
function LateEnrollmentHealthDetails() {
  ...
  const {
    ...
    medicalCondition,
    medicareNumber,
  } = lateEnrolledStudentData?.healthInformation ?? {}
  const { contactNumber, contactPerson, relationship } =
    lateEnrolledStudentData?.emergencyContact ?? {}
...
export default LateEnrollmentHealthDetails
