...
import { applicantParentDetailsSchema } from "@/types/Application/applicantSchema"
...
function ParentDetails() {
  ...
  const { fatherName, motherName, parentContact, parentEmail } =
    activeStudentData?.parentsDetails ?? {}
                  ...
                  <dl className="divide-y divide-gray-100">
                    <div className="px-4 py-2 sm:grid sm:grid-cols-4 sm:gap-x-4  sm:px-0">
                      ...
                      <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                        {fatherName && capitalizeFirstCharacter(fatherName)}
                      </dd>
                    </div>
                    ...
                    <div className="px-4 py-2 sm:grid sm:grid-cols-4 sm:gap-x-4  sm:px-0">
                      ...
                      <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                        {motherName && capitalizeFirstCharacter(motherName)}
                      </dd>
                    </div>
                    <div className="px-4 py-2 sm:grid sm:grid-cols-4 sm:gap-x-4  sm:px-0">
                      <dt className="text-sm font-medium leading-6 text-gray-900">
                      ...
                      {item != "parentEmail" && (
                        <>
                          <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                            {parentEmail &&
                              capitalizeFirstCharacter(parentEmail)}
                          </dd>
                          <button type="button">
                            <Icons.Pencil
                    ...
                    <div className="px-4 py-2 sm:grid sm:grid-cols-4 sm:gap-x-4  sm:px-0">
                      ...
                      {item != "parentContact" && (
                        <>
                          <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                            {parentContact && <span>{parentContact}</span>}
                          </dd>
                          <button type="button">
                            <Icons.Pencil
                              className="w-4 h-4 flex justify-center items-center text-blue-400"
